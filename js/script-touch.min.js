...
*/
function($){"use strict";$(function(){var width=$(window).width(),swipewidth=Math.floor(.16*width);swipewidth>150&&(swipewidth=150),50>swipewidth&&(swipewidth=50),$(".portfolio .project").swipe({swipeLeft:function(){},swipeRight:function(){},triggerOnTouchEnd:!1,threshold:swipewidth})})}(jQuery);/*! 
 * script.js 
 */
var assetBase=window.assets?window.assets:"",savedSelection;$(document).ready(function(){rangy.init(),$("#addLink").modal({show:!1}),$(document).on("mouseup",handleSelection).on("keyup",handleSelection),$(".add-bold").on("click",function(){toggleTag("strong")}),$(".add-italic").on("click",function(){toggleTag("em")}),$(".add-link").on("click",addLink),$("#addLink .save").on("click",addURL),$("#addLink .cancel").on("click",removeLink)});